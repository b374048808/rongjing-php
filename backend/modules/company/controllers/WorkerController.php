...
use backend\modules\company\forms\WorkerForm;
use backend\modules\company\forms\WorkerRoleForm;
...
class WorkerController extends BaseController
{
    ...
    public function actionRole()
    {
        ...
        return $this->renderAjax($this->action->id, [
            'model' => $model,
            'roles' => Yii::$app->services->rbacAuthRole->getDropDown(AppEnum::PROJECT),
        ]);
    }
