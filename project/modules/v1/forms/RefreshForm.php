...
use common\models\project\AccessToken;
use common\models\member\Member;
use common\enums\AccessTokenGroupEnum;

/**
 * Class RefreshForm
 * @package project\modules\v1\models
 */
class RefreshForm extends Model
{
    ...
    {
        if ($this->_user == false) {
            if (!($projectAccount = AccessToken::findIdentityByRefreshToken($this->refresh_token, $this->group))) {
                return false;
            }

            $this->_user = Member::findIdentity($projectAccount->member_id);
        }
