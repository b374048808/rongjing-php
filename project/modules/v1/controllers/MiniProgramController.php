...
use project\modules\v1\forms\MiniProgramLoginForm;
...
class MiniProgramController extends OnAuthController
{
    ...
    public function actionLogin()
    {
        ...
        return Yii::$app->services->projectAccessToken->getAccessToken($member, AccessTokenGroupEnum::WECHAT_MP);
    }
    ...
    public function actionQrCode()
    {
        ...
        // $response 成功时为 EasyWeChat\Kernel\Http\StreamResponse 实例，失败时为数组或者你指定的 project 返回格式
