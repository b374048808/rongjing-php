...
return [
    ...
    'modules' => [
        'v1' => [ // 版本1
            'class' => 'project\modules\v1\Module',
        ],
        'v2' => [ // 版本2
            'class' => 'project\modules\v2\Module',
        ],
    ],
    'components' => [
        'request' => [
            ...
            'rules' => [
                [
                    ...
                    'controller' => [
                        ...
                        'v1/project/item',
                        'v1/house/house',
                        'v1/project/item-contact',
                        'v1/project/item-number',
                        'v1/project/item-house',    //项目关联房屋
                        'v1/project/item-remove',
                        'v1/project/service',
                    ],
                    ...
                    'extraPatterns' => [
                        ...
                        'POST update-steps' => 'update-steps', // 
                        'POST update-config' => 'update-config', //  修改关联信息
                        'PUT update'    => 'update',
                        'PUT audit'    => 'audit',  //审核
