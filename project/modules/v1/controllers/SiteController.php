...
use project\modules\v1\forms\UpPwdForm;
use project\controllers\OnAuthController;
use project\modules\v1\forms\LoginForm;
use project\modules\v1\forms\RefreshForm;
use project\modules\v1\forms\MobileLogin;
use project\modules\v1\forms\SmsCodeForm;
use project\modules\v1\forms\RegisterForm;
...
class SiteController extends OnAuthController
{
    ...
    public function actionLogin()
    {
        ...
        if ($model->validate()) {
            return Yii::$app->services->projectAccessToken->getAccessToken($model->getUser(), $model->group);
        }
    ...
    {
        if (Yii::$app->services->projectAccessToken->disableByAccessToken(Yii::$app->user->identity->access_token)) {
    ...
    private function actionRegister()
    {
        ...
        return Yii::$app->services->projectAccessToken->getAccessToken($member, $model->group);
    }
